...
extension String {
    ...
    static let abstract: String = "Jamf Asset Downloader Extreme"
    static let discussion: String = "A Mac command-line tool to automate the downloading of your Jamf Nation assets."
